...
//
define ('BOX_TOOLS_DISPLAY_LOGS', 'Tampilkan File Log');
...
//
define ('DISPLAY_LOGS_MESSAGE_LOGS_PRESENT', '%1$u file debug-log ada, klik <a href="%2$s">disini</a> untuk melihat.');