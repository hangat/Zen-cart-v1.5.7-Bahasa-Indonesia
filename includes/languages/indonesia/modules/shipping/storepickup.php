...
define('MODULE_SHIPPING_STOREPICKUP_TEXT_TITLE', 'Penjemputan Toko');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_DESCRIPTION', 'Penjemputan Di Toko Pelanggan');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_WAY', 'Berjalan');
