 ...
 */
  ...
  if (IS_ADMIN_FLAG === true) {
    define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_DESCRIPTION', '<strong>PayPal Payments Pro</strong>%s<br />' . '<a href="https://www.paypal.com" rel="noreferrer noopener" target="_blank">Kelola akun PayPal Anda.</a>' . '<br /><br /><font color="green">Petunjuk Konfigurasi:</font><br /><span class="alert">1. </span><a href="https://www.zen-cart.com/partners/paypal-pro" rel="noopener" target="_blank">Daftar ke akun PayPal Anda - klik di sini.</a><br />' .
(defined('MODULE_PAYMENT_PAYPALDP_STATUS') ? '' : '... dan klik "instal" di atas untuk mengaktifkan PayPal Pembayaran Pro.<br /><a href="https://www.zen-cart.com/getpaypal" rel="noopener" target="_blank">Untuk bantuan terperinci tambahan, lihat artikel FAQ ini</a><br />') .
(!defined('MODULE_PAYMENT_PAYPALWPP_APISIGNATURE') || MODULE_PAYMENT_PAYPALWPP_APISIGNATURE === '' ? '<span class="alert">2. </span><strong>Kredensial API</strong> dari opsi Kredensial API di area Pengaturan Profil PayPal Anda. Modul ini menggunakan opsi <strong>API Signature</strong> - Anda akan memerlukan nama pengguna, kata sandi, dan tanda tangan untuk masuk dalam bidang di bawah ini.' : '<span class="alert">2. </span>Pastikan Anda telah memasukkan data keamanan yang sesuai untuk nama pengguna / pwd dll, di bawah ini.') .
'<font color="green"><hr /><strong>Persyaratan:</strong></font><br /><hr />*<strong>Checkout Kilat</strong> harus diinstal dan diaktifkan untuk menggunakan Pembayaran PayPal Pro, sesuai dengan Ketentuan Layanan PayPal. <br />*Juga memerlukan CURL melalui SSL untuk komunikasi keluar. CURL harus diaktifkan untuk port 80 dan 443.<hr />' );
  }
