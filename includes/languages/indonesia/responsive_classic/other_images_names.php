...
define('OTHER_BOX_NOTIFY_YES_ALT', 'Beritahu saya tentang perbaruan untuk produk ini.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Tulis ulasan tentang produk ini.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Situs ini sedang dalam perbaikan. Harap kembali lagi nanti.');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'PERSETUJUAN PELANGGAN TERTUNDA ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Bintang Lima');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Bintang Empat');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Bintang Tiga');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'Bintang Dua');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'Bintang Satu');
