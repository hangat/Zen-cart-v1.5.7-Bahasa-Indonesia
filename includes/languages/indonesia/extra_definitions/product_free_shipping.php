...
define('TEXT_PRODUCT_FREE_SHIPPING_ICON', zen_image(DIR_WS_TEMPLATE_IMAGES . 'always-free-shipping.gif', 'Selalu Gratis Biaya Pengiriman')); // for an image or comment out to use another
?>