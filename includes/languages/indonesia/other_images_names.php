...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Hapus pemberitahuan produk ini.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Beritahu saya tentang perbaruan pada produk ini.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'tulis sebuah ulasan mengenai produk ini.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Situs ini sedang tutup sementara untuk pemeliharaan. Silakan kembali lagi nanti.');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'PERSETUJUAN PELANGGAN DITUNDA ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Lima Bintang');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Empat Bintang');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Tiga Bintang');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'Dua Bintang');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'Satu Bintang');
