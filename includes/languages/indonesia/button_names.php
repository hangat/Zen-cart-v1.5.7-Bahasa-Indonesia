...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Daftar');
define('BUTTON_LOG_OFF_ALT', 'Logout');
define('BUTTON_ADD_ADDRESS_ALT', 'Tambahkan Alamat');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Tambahkan Produk terpilih ke Troli');
define('BUTTON_BACK_ALT', 'Kembali');
define('BUTTON_BUY_NOW_ALT', 'Beli Sekarang');
define('BUTTON_CANCEL_ALT', 'Batal');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Ganti Alamat');
define('BUTTON_CHECKOUT_ALT', 'Selesai Berbelanja');
define('BUTTON_CONFIRM_SEND_ALT', 'Kirim Kupon Hadiah');
define('BUTTON_CONFIRM_ORDER_ALT', 'Konfirmasi Pesanan');
define('BUTTON_CONTACT_US_TEXT', 'Hubungi Kami');
define('BUTTON_CONTINUE_ALT', 'Lanjutkan');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Lanjutkan Belanja');
define('BUTTON_DELETE_ALT', 'Hapus');
define('BUTTON_DELETE_SMALL_ALT', 'Hapus');
define('BUTTON_DOWNLOAD_ALT', 'Unduh Sekarang');
define('BUTTON_EDIT_SMALL_ALT', 'Edit');
define('BUTTON_IN_CART_ALT', 'Tambahkan ke Troli');
define('BUTTON_LOGIN_ALT', 'Login');
define('BUTTON_LOOKUP_ALT', 'Lihat');
define('BUTTON_MY_ORDERS_TEXT', 'Pesananku');
define('BUTTON_NEXT_ALT', 'Berikutnya');
define('BUTTON_PREVIOUS_ALT', 'Sebelumnya');
define('BUTTON_REDEEM_ALT', 'Tebus');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Kembali ke Daftar Produk');
define('BUTTON_REVIEWS_ALT', 'Pergi ke Halaman Ulasan');
define('BUTTON_SEARCH_ALT', 'Cari');
define('BUTTON_SEND_ALT', 'Kirim Sekarang');
define('BUTTON_SEND_ANOTHER_ALT', 'Kirim Kupon Hadiah yang Lain');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Kirim Sebuah Kupon Hadiah');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Penghitung Biaya Pengiriman');
define('BUTTON_SOLD_OUT_ALT', 'Habis Terjual');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Habis Terjual');
define('BUTTON_SUBMIT_ALT', 'Kirim Informasi');
define('BUTTON_UNSUBSCRIBE', 'Berhenti Berlangganan');
define('BUTTON_UPDATE_ALT', 'Perbarui');
define('BUTTON_VIEW_SMALL_ALT', 'Lihat');
define('BUTTON_WRITE_REVIEW_ALT', 'Tulis Ulasan');
define('BUTTON_READ_REVIEWS_ALT', 'Baca Ulasan');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Ke informasi detail produk ini');
define('BUTTON_MORE_REVIEWS_ALT', 'Baca ulasan lebih banyak');
define('BUTTON_VIEW_ALL_ALT', 'Lihat Semua');
define('BUTTON_ASK_A_QUESTION_ALT', 'Tanyakan');
