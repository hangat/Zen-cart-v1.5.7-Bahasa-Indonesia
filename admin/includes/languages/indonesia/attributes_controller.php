...
define('ATTRIBUTE_WARNING_DUPLICATE_UPDATE','Ada Duplikat Atribut - Atribut tidak diubah'); // attributes duplicate warning
define('ATTRIBUTE_WARNING_INVALID_MATCH','Atribut Opsi dan Nilai Opsi TIDAK SAMA - Atribut tidak ditambahkan'); // miss matched option and options value
define('ATTRIBUTE_WARNING_INVALID_MATCH_UPDATE','Atribut Opsi dan Nilai Opsi TIDAK SAMA - Atribut tidak diubah'); // miss matched option and options value
define('ATTRIBUTE_POSSIBLE_OPTIONS_NAME_WARNING_DUPLICATE','Kemungkinan Duplikan Nama Opsi ditambahkan'); // Options Name Duplicate warning
define('ATTRIBUTE_POSSIBLE_OPTIONS_VALUE_WARNING_DUPLICATE','Kemungkinan Duplikan Nilai Opsi ditambahkan'); // Options Value Duplicate warning
...
// preview
  ...
  define('BUTTON_ADDITIONAL_ACTIONS', 'Aksi Tambahan');
  define('TEXT_EDIT_OPTION_VALUE', 'Edit Nilai Opsi');
  define('TEXT_DELETE_OPTION_VALUE', 'Delete Nilai Opsi');
  define('TEXT_UPDATE_DEFAULT_SORT_ORDER', 'Perbarui pengurutan ke default (semula)');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_ATTRIBUTES', 'Tampilkan <b>%d</b> sampai <b>%d</b> (dari <b>%d</b> atribut)');
