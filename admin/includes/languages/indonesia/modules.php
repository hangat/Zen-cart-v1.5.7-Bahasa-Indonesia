...
define('TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED', 'Ini adalah email otomatis dari toko Zen Cart Anda untuk memberitahu anda tentang perubahan yang baru saja dibuat untuk pengaturan administratif Anda: ' . "\n\n" . 'CATATAN: Pengaturan Admin telah berubah. Modul [%s] telah DI INSTAL oleh admin Zen Cart anda %s.' . "\n\n" . 'Jika Anda tidak mengajukan perubahan ini, disarankan bahwa Anda memverifikasi pengaturan segera.' . "\n\n" .  'Jika Anda sudah mengetahui perubahan ini, Anda dapat mengabaikan email otomatis ini.');
define('TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED', 'Ini adalah email otomatis dari toko Zen Cart Anda untuk memberitahu anda tentang perubahan yang baru saja dibuat untuk pengaturan administratif Anda: ' . "\n\n" . 'CATATAN: Pengaturan Admin telah berubah. Modul [%s] telah DIHAPUS oleh admin Zen Cart anda %s.' . "\n\n" . 'Jika Anda tidak melakukan perubahan ini, Anda disarankan untuk segera memverifikasi pengaturan.' . "\n\n" . 'Jika Anda sudah mengetahui perubahan ini, Anda dapat mengabaikan email otomatis ini.');
define('TEXT_DELETE_INTRO', 'Anda yakin ingin menghapus modul ini?');
define('TEXT_WARNING_SSL_EDIT', 'PEMBERITAHUAN: <a href="https://docs.zen-cart.com/user/installing/enable_ssl/" rel="noopener" target="_blank">Untuk alasan keamanan, Editing modul ini dinonaktifkan sampai Admin Anda dikonfigurasi untuk SSL</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'PEMBERITAHUAN: <a href="https://docs.zen-cart.com/user/installing/enable_ssl/" rel="noopener" target="_blank">Untuk alasan keamanan, Pemasangan modul ini dinonaktifkan sampai Admin Anda dikonfigurasi untuk SSL</a>.');
